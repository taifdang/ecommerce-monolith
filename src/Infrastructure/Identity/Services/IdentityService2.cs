...
public class IdentityService2(
    ...
    ITokenService2 tokenService,
    AppSettings appSettings,
    ICurrentUserProvider currentUserProvider) : IIdentityService2
{
    private readonly UserManager<ApplicationUser> _userManager = userManager;
    private readonly SignInManager<ApplicationUser> _signInManager = signInManager;
    private readonly AppIdentityDbContext _appIdentityDbContext = appIdentityDbContext;
    private readonly ICookieService _cookieService = cookieService;
    private readonly ITokenService2 _tokenService = tokenService;
    ...
    public Task<Guid> RegisterNewUser(RegisterUserRequestDto request, CancellationToken cancellationToken)
    {
        throw new NotImplementedException();
    }
}
